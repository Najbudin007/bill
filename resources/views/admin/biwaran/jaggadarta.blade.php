                    ...
                    <div class="d-flex w-100">
                        <div class="inp">
                            ...
                            <select id="" name="gaupalika">
                                <option name="proffession" value="कृपया छान्नुहोस..." disabled selected>कृपया छान्नुहोस...
                                </option>
                ...
                <div class="container">
                    <div class="col-md-12 text-center mt-5">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            class="btn btn-success btn-sm">सुरक्षित गर्नुहोस्</button>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('jagga_darta.create') }}"><button type="button"
                                            class="btn btn-secondary" data-bs-dismiss="modal">हो</button></a>
